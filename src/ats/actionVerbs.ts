 ...
 *
 *  Shared by the CVscan analyser and the CVisor critic — they used to keep
 *  separate word lists, which drifted until a CV whose every bullet opened
 *  with a real verb ("Coordinated", "Executed", "Deployed") scored 0%.
 *  api/_lib/actionVerbs.ts is a copy of this file for the serverless
 *  functions, and a test fails if the two ever diverge again.
 *
