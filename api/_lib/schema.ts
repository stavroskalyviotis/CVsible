  ...
  return {
    ...
    properties: {
      summary: {
        type: "string",
        description:
          "Σύντομο επαγγελματικό προφίλ (2-4 προτάσεις), προσαρμοσμένο στην αγγελία. Απλό κείμενο ή βασικό HTML (<p>, <strong>).",
      },
      suggestedJobTitle: {
        type: "string",
        description:
          "Πρόταση για σύντομο επαγγελματικό τίτλο (π.χ. 'Senior Product Designer'), βασισμένη στην εμπειρία του χρήστη — ρεαλιστικός για το επίπεδό του, όχι απλή αντιγραφή του τίτλου της αγγελίας αν δεν ταιριάζει.",
      },
      experience: {
        type: "array",
        items: {
        ...
        items: {
          ...
          properties: {
            ...
            relevant: {
              type: "boolean",
              description:
                "true αν η δεξιότητα σχετίζεται/βοηθάει για αυτή τη συγκεκριμένη αγγελία εργασίας. false ΜΟΝΟ αν πραγματικά δεν έχει καμία σχέση με τη θέση — όχι απλά επειδή δεν αναφέρεται ρητά στην αγγελία (πολλές χρήσιμες δεξιότητες δεν αναφέρονται ρητά). Στην αμφιβολία, true.",
            },
          },
        },
      },
      ...
      suggestedSkills: {
        type: "array",
        description:
          "Επιπλέον δεξιότητες που θα ήταν λογικό να έχει κάποιος σε αυτή τη θέση, βάσει της αγγελίας — προτάσεις για να επιλέξει ο χρήστης. ΜΗΝ συμπεριλάβεις καμία δεξιότητα που ήδη υπάρχει στο skills, ούτε παραλλαγή/συνώνυμό της (π.χ. αν υπάρχει ήδη 'Python', μην προτείνεις 'Python Programming' ή 'Προγραμματισμός Python').",
        items: {
          type: "object",
          additionalProperties: false,
          required: ["name"],
      ...
      suggestedSoftSkills: {
        type: "array",
        description:
          "Επιπλέον ήπιες δεξιότητες που θα ταίριαζαν σε αυτή τη θέση, βάσει της αγγελίας — προτάσεις. ΜΗΝ συμπεριλάβεις καμία που ήδη προκύπτει από το κείμενο του χρήστη (softSkills), ούτε παραλλαγή/συνώνυμό της.",
        items: {
          type: "object",
          additionalProperties: false,
          required: ["name"],
      ...
      themeColor: {
        type: "string",
        description: "Προτεινόμενο χρώμα θέματος για το βιογραφικό, ταιριαστό με τον κλάδο/τόνο της αγγελίας.",
        enum: [...themeColorIds],
      },
    },
  } as const;
